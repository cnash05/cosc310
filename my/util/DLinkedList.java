//DLinkedList distributes the storage of all data
//DLinkedList object is a bunch of nodes with a refernevce to first node(head) and last node(tail)
//Both head and tail has a forward and backward link. Both head and tail and node is a DNode
//Each DNode has a reference to previous node and next node and data
//DLinkedList has methods to add nodes at the beginning, end, and after a given node
//If you are adding stuff at beginning use LinkedList rather than array list
//
